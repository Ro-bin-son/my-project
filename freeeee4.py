...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.button0.clicked.connect(self.on_process)
    ...
    def on_process(self):
        ...
        self.lineEdit.hide()
        try:
            self.button0.clicked.disconnect()
        except:
            pass
    ...
    def lying(self):
        ...
        QTimer.singleShot(3000, lambda: (
            ...
            QTimer.singleShot(3000, lambda: self.check1.setChecked(True) if user >= limit else self.check1.setChecked(
                False), ),
        ))
