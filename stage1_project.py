...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.questions = [
                {"q": "Who is ", "answers": ["robinson", "robin"], "placeholder": "Type his name here"},
                {"q": "How many elephant emojis do you\n see down here?\n  🐘🐇🐍🐘🐕🐒🐘🐖🐘",
                 "answers": ["4", "four"], "placeholder": "Type your answer"},
                {"q": "What is your favorite color?\n (blue/green/red)", "answers": ["blue", "green", "red"],
                 "placeholder":
                         "Type your color"},
    ...
    def close_program(self):
        ...
        self.button2.hide()
        self.lineEdit.hide()
        QTimer.singleShot(1000, self.close)  # close after 3 sec
    ...
    def validate_answer(self):
        ...
        if user_input in correct_answers:
            ...
            self.label.setGeometry(200, 120, 650, 80)
            # blinking limited time
    ...
    def toggle_blink(self):
        ...
        if self.blink_count >= 2:
            ...
            self.label.setText("")
            self.label.setStyleSheet("font-size: 35px; color: lightgreen; font-weight: bold;")
            QTimer.singleShot(5, self.show_question)
    ...
    def shake_input(self):
        ...
        # Reset border back after 1 second
        QTimer.singleShot(1000, lambda: self.lineEdit.setStyleSheet(
            "font-size: 25px; background-color: hsl(180, 38%, 47%); "
